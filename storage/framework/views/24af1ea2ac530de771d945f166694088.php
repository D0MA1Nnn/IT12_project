...
<div class="owner-summary-grid">
    ...
    <a href="<?php echo e(route('products.index')); ?>" class="owner-stat-card">
        ...
        <div class="owner-stat-value">
            <?php echo e(number_format($productCount)); ?>
    ...
    <a
        href="<?php echo e(route('products.index', ['stock' => 'low'])); ?>"
    ...
    >
        ...
        <div class="owner-stat-value <?php echo e($lowStockCount > 0 ? 'text-danger' : ''); ?>">
    ...
    <a href="<?php echo e(route('purchases.index')); ?>" class="owner-stat-card">
        <div class="owner-stat-header">
        ...
        <div class="owner-stat-value">
            ₱<?php echo e(number_format((float) $todayPurchaseAmount, 2)); ?>

        </div>

        <div class="owner-stat-footer">
            <?php echo e(number_format($todayPurchaseCount)); ?>

            <?php echo e($todayPurchaseCount == 1 ? 'purchase' : 'purchases'); ?>
    ...
    >
        ...
        <div class="owner-stat-value">
            ₱<?php echo e(number_format((float) $todaySalesAmount, 2)); ?>

        </div>

        <div class="owner-stat-footer">
            <?php echo e(number_format($todaySalesCount)); ?>

            <?php echo e($todaySalesCount == 1 ? 'transaction' : 'transactions'); ?>
...
<div class="owner-secondary-grid">
    ...
    <a href="<?php echo e(route('categories.index')); ?>" class="owner-mini-card">
        <div>
            <span>Categories</span>
            <small>Material classifications</small>
        </div>

        <strong><?php echo e(number_format($categoryCount)); ?></strong>
    </a>


    <a href="<?php echo e(route('suppliers.index')); ?>" class="owner-mini-card">
        <div>
            <span>Suppliers</span>
            <small>Active supplier records</small>
        </div>

        <strong><?php echo e(number_format($supplierCount)); ?></strong>
    </a>


    <a href="<?php echo e(route('users.index')); ?>" class="owner-mini-card">
        <div>
    ...
    <div class="owner-table-wrapper">
        ...
        <table class="table owner-dashboard-table">
            ...
            <tbody>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $lowStockItems; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $inventory): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <div class="owner-transaction-row">
                    ...
                    <div class="owner-transaction-info">
                        ...
                        <?php if($purchase->supplier): ?>
                            ...
                            <small>
                                <?php echo e($purchase->supplier->supplier_name); ?>
                ...
                <div class="owner-transaction-row">
                    ...
                    <div class="owner-transaction-info">
                        ...
                        <?php if($sale->user): ?>
                            ...
                            <small>
                                Recorded by <?php echo e($sale->user->username); ?>
            ...
            <tbody>
                ...
                <?php $__empty_1 = true; $__currentLoopData = $recentActivities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    ...
                    <tr>
                        ...
                        <td>
                            <?php echo e($activity->user?->username ?? 'System'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Projects\IT12_project\resources\views/dashboard/owner.blade.php ENDPATH**/ ?>