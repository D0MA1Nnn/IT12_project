...
<div class="page">
    ...
    <section class="right">
        ...
        <div class="card">
            ...
            <?php if(session('attempt_warning')): ?>
                ...
                <div class="alert alert-warning">
                    ...
                    <div>
                        <?php echo e(session('attempt_warning')); ?>
...
document.addEventListener(
    ...
    function () {
        ...
        let remainingSeconds =
            <?php echo e((int) session('lockout_seconds', 0)); ?>;

        const isLocked =
            <?php echo e(session('login_locked') ? 'true' : 'false'); ?>;
...
</html><?php /**PATH C:\Projects\IT12_project\resources\views/auth/login.blade.php ENDPATH**/ ?>