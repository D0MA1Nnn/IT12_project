        ...
        <aside class="sidebar">
            ...
            <nav class="nav">
                ...
                <?php if(auth()->user()->role === 'OWNER'): ?>
                    ...
                    <a
                        class="<?php echo e(request()->routeIs('suppliers.*', 'purchases.*') ? 'active' : ''); ?>"
                    ...
                    <a
                        class="<?php echo e(request()->routeIs('activity.*') ? 'active' : ''); ?>"
                    ...
                    <a
                        class="<?php echo e(request()->routeIs('backup.*') ? 'active' : ''); ?>"
